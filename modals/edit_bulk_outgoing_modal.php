...
<script>
    $('#editb_outgoing_modal').on('hidden.bs.modal', function () {
        ...
        document.getElementById('OutgoingStatusFormb').reset();
    });
    ...
    $('#OutgoingContainerDetailsFormb').on('submit', function(event) {
        event.preventDefault(); // Prevent the default form submission
        // Serialize the form data
        var formData = $(this).serialize();
        var additionalData = $.param({ 'outgoing_details_ref': selectedIds });
        ...
        $.ajax({
            type: 'POST', // or 'GET' depending on your needs
            url: '../php_api/outgoing_bulk_edits/container.php', // Replace with your server endpoint
            data: combinedData,
            dataType: 'json',
            success: function(response) {
                if (response.notification) {
    ...
    $('#OutgoingDispatchingDetailsFormb').on('submit', function(event) {
        event.preventDefault(); // Prevent the default form submission
        // Serialize the form data
        var formData = $(this).serialize();
        var additionalData = $.param({ 'outgoing_details_ref': selectedIds });
        ...
        $.ajax({
            type: 'POST', // or 'GET' depending on your needs
            url: '../php_api/outgoing_bulk_edits/dispatch.php', // Replace with your server endpoint
            data: combinedData,
            dataType: 'json',
            success: function(response) {
                if (response.notification) {
    ...
    $('#OutgoingContLineUpFormb').on('submit', function(event) {
        event.preventDefault(); // Prevent the default form submission
        // Serialize the form data
        var formData = $(this).serialize();
        var additionalData = $.param({ 'outgoing_details_ref': selectedIds });
    ...
    $('#OutgoingStatusFormb').on('submit', function(event) {
        event.preventDefault(); // Prevent the default form submission
        // Serialize the form data
        var formData = $(this).serialize();
        var additionalData = $.param({ 'outgoing_details_ref': selectedIds });
        ...
        $.ajax({
            type: 'POST', // or 'GET' depending on your needs
            url: '../php_api/outgoing_bulk_edits/status.php', // Replace with your server endpoint
            data: combinedData,
            dataType: 'json',
            success: function(response) {
                if (response.notification) {
