<?php
    ...
    if ($shipment) {
        //revision check shipping line to close off some details
        $shipping_line_lock = $shipment['shipping_lines'] == "LCL" ? "readonly" : "";
        ...
        $return_body['shipment'] .= <<<HTML
                ...
                <div class="col-6">
                    ...
                    <select class="form-control" name="shipping_lines" required>
            ...
            <div class="row mb-2">
                <div class="col-6">
                    ...
                    <select class="form-control" name="forwarder_name" required>
    ...
    if ($shipment) {
        ...
        $return_body['delivery_plan'] = <<<HTML
            ...
            <div class="row mb-2">
                <div class="col-6">
                    <label>TABS</label>
                    <input value="{$shipment['tabs']}" type="text" class="form-control" name="tabs" {$shipping_line_lock}>
                </div>
            </div>
        ...
        $return_body['completion_details'] = <<<HTML
            ...
            <div class="row mb-2">
                <div class="col-6">
                    ...
                    <input type="date" value="{$shipment['date_port_out']}" class="form-control" name="date_port_out" {$shipping_line_lock}>
                </div>
                <div class="col-6">
        ...
        $return_body['mmsystem_details'] = <<<HTML
            ...
            <div class="row mb-2">
                <div class="col-6">
                    ...
                    <input value="{$shipment['container_status']}" type="text" class="form-control" name="container_status" {$shipping_line_lock}>
                </div>
                <div class="col-6">
                    <label>DATE RETURN / REUSED</label>
                    <input value="{$shipment['date_return_reused']}" type="date" class="form-control" name="date_return_reused" {$shipping_line_lock}>
                </div>
            </div>
            <div class="row mb-2">
                <div class="col-6">
                    <label>NO. DAYS AT PORT</label>
                    <input readonly value="{$shipment['no_days_port']}" type="number" class="form-control" name="no_days_port" {$shipping_line_lock}>
                </div>
                <div class="col-6">
                    <label>NO. DAYS AT FALP</label>
                    <input readonly value="{$shipment['no_days_falp']}" type="number" class="form-control" name="no_days_falp" {$shipping_line_lock}>
                </div>
            </div>
            <div class="row mb-2 d-flex align-items-center">
                <div class="col-3 ml-auto">
