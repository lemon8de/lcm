<?php
    ...
    $sql = "SELECT shipment_details_ref from m_shipment_sea_details where bl_number in ($placeholders)";
    ...
    if ($shipment_details_ref_list = $stmt -> fetchAll(PDO::FETCH_COLUMN)) {
