<?php
    ...
    $sql = "EXEC Outgoing_BULK_Vessel :ModeOfShipment, :VesselName, :ShippingLine, :ETDMnl, :ETADestination, :OutgoingDetailRefs";
    $stmt_update = $conn -> prepare($sql);
    $stmt_update -> bindParam(":ModeOfShipment", $_POST['mode_of_shipment']);
    $stmt_update -> bindParam(":VesselName", $_POST['vessel_name']);
    $stmt_update -> bindParam(":ShippingLine", $_POST['shipping_line']);
    $stmt_update -> bindParam(":ETDMnl", $_POST['etd_mnl']);
    $stmt_update -> bindParam(":ETADestination", $_POST['eta_destination']);
