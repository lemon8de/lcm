<?php
    ...
    $stmt_history -> bindValue(":table_name", 'm_outgoing_status_details');
    ...
    $sql = "EXEC Outgoing_BULK_Status :Status, :CoStatus, :OutgoingDetailRefs";
    $stmt_update = $conn -> prepare($sql);
    $stmt_update -> bindParam(":Status", $_POST['status']);
    $stmt_update -> bindParam(":CoStatus", $_POST['co_status']);
