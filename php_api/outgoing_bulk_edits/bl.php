<?php
    ...
    $stmt_history -> bindValue(":table_name", 'm_outgoing_bl_details');
    ...
    $sql = "EXEC Outgoing_BULK_BL :BlDate, :BlNumber, :OutgoingDetailRefs";
    $stmt_update = $conn -> prepare($sql);
    $stmt_update -> bindParam(":BlDate", $_POST['bl_date']);
    $stmt_update -> bindParam(":BlNumber", $_POST['bl_number']);
