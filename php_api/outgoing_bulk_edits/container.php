<?php
    ...
    $sql = "EXEC Outgoing_BULK_Container :FalpInReuse, :StatusOfContainer, :ContainerSize, :Forwarder, :OutgoingDetailRefs";
    $stmt_update = $conn -> prepare($sql);
    $stmt_update -> bindParam(":FalpInReuse", $_POST['falp_in_reuse']);
    $stmt_update -> bindParam(":StatusOfContainer", $_POST['status_of_container']);
    $stmt_update -> bindParam(":ContainerSize", $_POST['container_size']);
    $stmt_update -> bindParam(":Forwarder", $_POST['forwarder']);
