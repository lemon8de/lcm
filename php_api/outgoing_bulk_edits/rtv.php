<?php
    ...
    $stmt_history -> bindValue(":table_name", 'm_outgoing_rtv');
    ...
    $sql = "EXEC Outgoing_BULK_RTV :IrregularShipment, :OutgoingDetailRefs";
    $stmt_update = $conn -> prepare($sql);
    $stmt_update -> bindParam(":IrregularShipment", $_POST['irregular_shipment']);
