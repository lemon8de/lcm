<?php
    ...
    $stmt_history -> bindValue(":table_name", 'm_outgoing_cont_lineup');
    ...
    $sql = "EXEC Outgoing_BULK_ContLineUp :FalpOutDate, :FalpOutTime, :TruckHeadStatus, :OutgoingDetailRefs";
    $stmt_update = $conn -> prepare($sql);
    $stmt_update -> bindParam(":FalpOutDate", $_POST['falp_out_date']);
    $stmt_update -> bindParam(":FalpOutTime", $_POST['falp_out_time']);
    $stmt_update -> bindParam(":TruckHeadStatus", $_POST['truckhead_status']);
