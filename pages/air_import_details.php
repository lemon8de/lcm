<?php
    ...
    $directory = " / Incoming Delivery / Air Shipments / Import Data Report Generation";
    $bar_whois_active = "air_import_details";
            ...
            <div class="content-wrapper">
                <div class="content-header">
                    <div class="container-fluid">
                        <?php include 'content/air_import_details_content.php'?>
                    </div>
                </div>
            </div>
