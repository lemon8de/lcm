<?php
    ...
    $directory = " / Incoming Delivery / Sea Shipments / Active Report Generation";
    $bar_whois_active = "sea_active_details";
            ...
            <div class="content-wrapper">
                <div class="content-header">
                    <div class="container-fluid">
                        <?php include 'content/active_report_sea_content.php'?>
                    </div>
                </div>
            </div>
